...
```bash
npx add-skill Gamma-Software/build-in-public-skill           # all detected agents
npx add-skill Gamma-Software/build-in-public-skill --global  # globally
```

Or manually:

```bash
git clone https://github.com/Gamma-Software/build-in-public-skill.git
ln -s "$PWD/build-in-public-skill" ~/.claude/skills/build-in-public   # or copy it
```
